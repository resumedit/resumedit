...
import { ItemClientStateType, ItemDisposition, OrderableItemClientStateType } from "@/types/item";
 ...
 */
export const findItemIndexByClientId = (arr: ItemClientStateType[], id: IdSchemaType): number => {
...
const getOrderParams = (items: OrderableItemClientStateType[]) => {
...
export const getOrderValueForAppending = (items: OrderableItemClientStateType[]): number => {
  if (items.length === 0) {
...
export const reBalanceListOrderValues = (
  items: OrderableItemClientStateType[],
  force?: boolean,
...
const getAdjustedOrderValue = (
  item: OrderableItemClientStateType,
...
const adjustListOrderValues = (items: OrderableItemClientStateType[]): OrderableItemClientStateType[] => {
  ...
  return items.map((item, index): OrderableItemClientStateType => {
...
const validateListOrderValues = (items: OrderableItemClientStateType[]): boolean => {
...
export const updateListOrderValues = (items: OrderableItemClientStateType[]): OrderableItemClientStateType[] => {
